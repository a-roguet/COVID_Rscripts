...
5. Merge all data
```{r}
qPCR.final<-cbind(qPCR[,c("City", "Collection_Date_End", "Collection_Date_Start", "Target", "CV", "CDC_analytical_comment")], HF183)
```
...
ddPCR.qPCR.check[2,]<-c("class(ddPCR.qPCR$Collection_Date_End)=character", isTRUE(class(ddPCR.qPCR$Collection_Date_End)=="character"))
