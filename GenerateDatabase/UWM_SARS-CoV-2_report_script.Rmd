...
file.copy(from=paste0("~/OneDrive - UWM/SARS-CoV-2/REPORTS/CDC_DHS_reports/", rmd.sample.selection), to=paste0("~/OneDrive - UWM/SARS-CoV-2/REPORTS/CDC_DHS_reports/", current_time1, "/", gsub("_DO_NOT_MODIFY", "", rmd.sample.selection)), overwrite = TRUE, copy.mode = TRUE)
