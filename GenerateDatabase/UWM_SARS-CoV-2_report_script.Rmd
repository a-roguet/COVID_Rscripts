...
### ddPCR and qPCR data
ddPCR and qPCR data are stored in the tab "Raw data ddPCR" in the excel file "Experiment data summary in categories - Editable.xlsx" in Sandra's OneDrive: https://panthers-my.sharepoint.com/personal/mclellan_uwm_edu/Documents/SARS-CoV-2/.
```{r }
data.ddPCR<-read.xlsx("~/OneDrive - UWM/SARS-CoV-2/Experiment data summary in categories - Editable.xlsx", sheet = "Raw data", colNames = TRUE, startRow = 4)
```

ddPCR and qPCR data are stored in the tab "Raw data qPCR" in the excel file "Experiment data summary in categories - Editable.xlsx" in Sandra's OneDrive: https://panthers-my.sharepoint.com/personal/mclellan_uwm_edu/Documents/SARS-CoV-2/.
```{r }
data.qPCR<-read.xlsx("~/OneDrive - UWM/SARS-CoV-2/Experiment data summary in categories - Editable.xlsx", sheet = "Raw data qPCR", colNames = TRUE, startRow = 4)
```


### metadata
Sample info are stored in the tab "Sample extraction" in the excel file "Experiment data summary in categories - Editable.xlsx" in Sandra's OneDrive: https://panthers-my.sharepoint.com/personal/mclellan_uwm_edu/Documents/SARS-CoV-2/.
```{r }
sample.info<-read.xlsx("~/OneDrive - UWM/SARS-CoV-2/Experiment data summary in categories - Editable.xlsx", sheet = "Sample extraction", colNames = TRUE, startRow = 3)
```
...
file.copy(from="~/OneDrive - UWM/SARS-CoV-2/Experiment data summary in categories - Editable.xlsx", to=paste0("~/OneDrive - UWM/SARS-CoV-2/REPORTS/CDC_DHS_reports/", current_time, "/RawData/Experiment data summary in categories - Editable.xlsx"), overwrite = TRUE, copy.mode = TRUE)
...
```{r}
#date.assays.year<-as.data.frame(setDT(data.ddPCR)[, tstrsplit(Run, '[-]', type.convert=TRUE)])[,1]
#date.assays.year<-ifelse(date.assays.year>=8, "-2020", "-2021")
date.assays<-as.data.frame(setDT(data.ddPCR)[, tstrsplit(Run, '[ ]', type.convert=TRUE)])[,1]
#date.assays<-paste0(date.assays, date.assays.year)
